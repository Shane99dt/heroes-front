...
const NavBar = () => {
  ...
  return (
    <>
      <nav className="p-5 bg-black shadow md:flex md:items-center md:justify-between text-white font-medium">
        <div className="flex justify-between items-center ">
          <Link
            className="text-2xl font-[Poppins] cursor-pointer capitalize"
            to="/heroes"
          >
            Heroes
          </Link>
        ...
        ${
          clicked
            ? "z-30 pl-7 py-4 fixed bg-gray-800/80"
